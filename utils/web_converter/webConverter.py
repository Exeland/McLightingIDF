...
if args.repopath != None:
    ...
    print("[+] Using manual path '" + str(parent) + "'\n")
...
for file in html_files:
    ...
    progmem_definitions += "const char " + array_name + "[] ICACHE_RODATA_ATTR = {" + hex_formatted_content + "};\n"
...
f.write("\n")
f.write("#ifndef ICACHE_RODATA_ATTR\n")
f.write("#define ICACHE_RODATA_ATTR \n")
f.write("#endif\n")
f.write("\n")
